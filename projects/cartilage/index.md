...
Use the topic chips on the Publications page to filter by terms (or search for “cartilage”).

{%
  include button.html
  link="research?search=cartilage"
  text="Search publications for cartilage"
