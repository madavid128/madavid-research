...
{%
  include button.html
  link="research?search=%22machine%20learning%22"
  text="Search publications for machine learning"
  icon="fa-solid fa-book-open"
  style="solid"
%}
{%
  include button.html
  link="research?search=imaging"
  text="Search publications for imaging"
  icon="fa-solid fa-book-open"
  style="bare"
%}
