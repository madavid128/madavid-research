...
This repository is based on the Greene Lab **Lab Website Template** and is licensed under **BSD 3‑Clause** (see `LICENSE.md`).
...
Currently, the MIT‑licensed files are:
- `_cite/wordclouds.py`
- `make_mad_icons.py`
- `tools/generate_third_party_notices.py`
- `tools/make_network_background.py`
