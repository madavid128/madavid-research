# Home page archive (reference)

This file keeps an archive of the earlier (longer) home page content that was later simplified. It is **not** used by the Jekyll site build.

## Previous `index.md` content
